...
namespace NeuralArt{
  ...
  public sealed partial class MainForm:Form{
    ...
    public void OpenContentHandler(object sender, EventArgs E){
      ...
      OFD.Title = "Open the content image";
      OFD.Filter = "Images (*.bmp; *.emf; *.exif; *.gif; *.ico; *.jpg; *.png; *.tiff; *.wmf)|*.bmp; *.emf; *.exif; *.gif; *.ico; *.jpg; *.png; *.tiff; *.wmf|All|*.*";
    ...
    public void SaveResultHandler(object sender, EventArgs E){
      ...
      SFD.Title = "Save result";
      SFD.Filter = "Image (*.bmp)|*.bmp|Image (*.emf)|*.emf|Image (*.exif)|*.exif|Image (*.gif)|*.gif|Image (*.ico)|*.ico|Image (*.jpg)|*.jpg|Image (*.png)|*.png|Image (*.tiff)|*.tiff|Image (*.wmf)|*.wmf";
    ...
    public void OpenStyleHandler(object sender, EventArgs E){
      var OFD = new OpenFileDialog();
      OFD.Title = "Open the style image";
      OFD.Filter = "Images (*.bmp; *.emf; *.exif; *.gif; *.ico; *.jpg; *.png; *.tiff; *.wmf)|*.bmp; *.emf; *.exif; *.gif; *.ico; *.jpg; *.png; *.tiff; *.wmf|All|*.*";
      if(OFD.ShowDialog() == DialogResult.OK){
